...
import { WhatIsUiUxApi } from "../api/contextApi";
import Layout from "../components/Layout";
import NextButton from "../components/NextButton";
export default function UiUxDesignScreen() {
  const { image_url, header_text, main_text, list_text } = WhatIsUiUxApi;
  return (
    <ScrollView>
      <Layout>
        ...
        <NextButton path="Languages For Web" />
      </Layout>
    </ScrollView>
  );
}
